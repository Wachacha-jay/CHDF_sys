  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        {/* Footer */}
        <div className="text-center text-sm text-gray-500 border-t border-gray-200 pt-6 space-y-1">
          <p>Thank you for your business!</p>
          <p>Generated by {businessSettings.business_name} - {new Date().toLocaleDateString()}</p>
          <p className="text-xs text-gray-400">Prepared by: <strong className="text-gray-600">{user?.name || user?.email || 'System'}</strong></p>
        </div>
      </div>
